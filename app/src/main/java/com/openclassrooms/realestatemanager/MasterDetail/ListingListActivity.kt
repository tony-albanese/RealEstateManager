 ...
 * lead to a [ListingDetailActivity] representing
...
class ListingListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (listing_detail_container != null) {
    ...
    class SimpleItemRecyclerViewAdapter(private val parentActivity: ListingListActivity,
                ...
                if (twoPane) {
                    val fragment = ListingDetailFragment().apply {
                        arguments = Bundle().apply {
                            putString(ListingDetailFragment.ARG_ITEM_ID, item.id)
                        }
                    }
                    ...
                    val intent = Intent(v.context, ListingDetailActivity::class.java).apply {
                        putExtra(ListingDetailFragment.ARG_ITEM_ID, item.id)
                    }
