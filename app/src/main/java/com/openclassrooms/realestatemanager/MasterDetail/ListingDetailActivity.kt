        ...
        if (savedInstanceState == null) {
            ...
            val fragment = ListingDetailFragment().apply {
                arguments = Bundle().apply {
                    putString(ListingDetailFragment.ARG_ITEM_ID,
                            intent.getStringExtra(ListingDetailFragment.ARG_ITEM_ID))
                }
            }
    ...
    override fun onOptionsItemSelected(item: MenuItem) =
            when (item.itemId) {
                android.R.id.home -> {
                    ...
                    navigateUpTo(Intent(this, ListingListActivity::class.java))
                    true
                }
